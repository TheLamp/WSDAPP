...
class ElemLunchViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        FIRDatabase.database().reference().child("lunchMenu").child("elemSchool").child(date).observeSingleEvent(of: .value, with: { (snapshot) in
